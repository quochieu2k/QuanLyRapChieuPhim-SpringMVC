...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Sửa Thông Tin Rạp</h1>
    <div class="row justify-content-center">
        ...
        <div class="col-xl-8 col-lg-12 col-md-9">
            <form:form method="post" modelAttribute="rap">
                ...
                <div class="form-group">
                    <form:input path="ktngang" class = "form-control form-control-user" id = "exampleInputEmail" placeholder = "Kích thước ngang..." aria_describedby = "emailHelp" />
                	<form:errors path = "ktngang" cssClass = "text-danger" />
                </div>
                <div class="form-group">
                    <form:input path="ktdoc" class = "form-control form-control-user" id = "exampleInputEmail" placeholder = "Kích thước dọc..." aria_describedby = "emailHelp" />
