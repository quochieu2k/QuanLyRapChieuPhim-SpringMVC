...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Thêm Phim Mới</h1>
        ...
        <div class="col-xl-8 col-lg-12 col-md-9">
            <form:form method="post" modelAttribute="phim" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="PosterImage" aria-describedby="emailHelp" required/><br />
                ...
                <div class="form-group">
                    <form:input path="thoiluong" class = "form-control form-control-user" id = "exampleInputEmail" placeholder = "Thời Lượng Phim..." aria_describedby = "emailHelp" onfocus = "(this.value='')"/>
