...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Sửa Suất Chiếu</h1>
    <div class="row justify-content-center">
        ...
        <div class="col-xl-8 col-lg-12 col-md-9">
            <form:form method="post" modelAttribute="suatchieu">
                ...
                <div class="form-group">
                	<form:input path="giave" class="form-control form-control-user" id="exampleInputEmail" placeholder="Giá Vé..." type="text" aria_describedby="emailHelp"/>
